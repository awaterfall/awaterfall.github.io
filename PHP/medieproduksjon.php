...
<head>
<title>Medieproduksjon Anders</title> <!-- Tekst og bilde i fanene -->
...
<body>
  ...
  <!-- Alt du ser på nettsiden er under her -->
    <div class="dropdown"> 
        ...
        <a class="dropbutton" onclick="menyknapp(this)">Medieproduksjon
  ...
  <div class="innhold"> <!-- HOVEDINNHOLD -->
    <div class="in">  <!-- Gjør at tekst ligger naturlig -->      
      ...
      <iframe src="https://www.youtube.com/embed/PzC8bzQqWdg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> <!-- Video på nettsiden -->
