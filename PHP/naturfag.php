...
<head>
<title>Naturfag Anders</title> <!-- Tekst og bilde i fanene -->
...
<body>
  ...
  <!-- Alt du ser på nettsiden er under her -->
    ...
    <div class="dropdown">
        ...
        <a class="dropbutton" onclick="menyknapp(this)">Naturfag
  ...
  <div class="innhold"> <!-- HOVEDINNHOLD -->
    <div class="in">  <!-- Gjør at tekst ligger naturlig -->
      ...
      Oppgave supermat: <a href="Presentasjoner/Diranuai - Naturfag.pptx">Last ned</a> <!-- Nedlastningslink til en oppgave i naturfag -->
